...
- ``` dotnet tool install dotnet-ef ``` - instalacja narzędzi EF Core
- ``` dotnet tool update dotnet-ef ``` - aktualizacja narzędzi EF Core
- ``` dotnet tool uninstall dotnet-ef ``` - odinstalowane narzędzi EF Core
